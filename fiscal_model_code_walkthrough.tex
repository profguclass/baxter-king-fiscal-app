...
($N,L,Y,K,K^G,C,I,G,I^G,G_T$) --- twenty-eight fields in total.
...
\item[\textbf{L194--L195}] $I^G=s_{IG}Y$, $G_T=s_{GT}Y$.
\item[\textbf{L196}] $G=I^G+G_T$, total government spending; by
