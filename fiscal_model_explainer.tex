...
switched on. This is exactly why the app's own Table 4 panel documents that
its $\theta_G=0$ row reproduces the \emph{ordinary} lump-sum
government-purchases multiplier ($\approx 1.16$), not zero.
