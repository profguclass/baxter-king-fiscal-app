...
through five cases that are easy to get wrong intuitively --- why a
...
saddle path altogether at extreme income-tax rates; and why a
``temporary'' spending increase does not bring the economy back to where
it started once the underlying policy regime has changed. Part III derives
